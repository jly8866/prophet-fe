            ...
            <Col :span="3" class="layout-menu-left">
                <Menu theme="dark" width="auto" :open-names="subMenuOpenKeys">
                    <div class="layout-logo-left">
						...
						<span><font color="white"><B>Prophet平台</B></font></span>
					</div>
                    <Submenu name="hive_operation" key="hive_operation">
                        <template slot="title">
                            <Icon type="ios-keypad"></Icon>
                            <span class="layout-text">自助查询</span>
                        </template>
                        <MenuItem name="hive_query" @click.native="forward('hive_query')">
							<Icon type="ios-list-outline"></Icon>
							<span class="layout-text">发起查询</span>
						</MenuItem>
						<!-- <MenuItem name="update_metadata" @click.native="forward('update_metadata')">
							<Icon type="ios-list-outline"></Icon>
							<span class="layout-text">更新metadata</span>
						</MenuItem> -->
